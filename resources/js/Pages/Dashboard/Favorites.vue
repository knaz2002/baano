<template>
    <DashboardLayout>
        <div class="bg-white rounded-2xl shadow-lg p-6">
            <h1 class="text-2xl font-bold mb-6" style="color: #1F4234;">Избранное</h1>
                ...
                >
                    <Link :href="`/listings/${favorite.favoritable.id}`" class="block">
                        ...
                        <div class="p-5 price-accent">
                            ...
                            <p class="text-sm mb-2" style="color: #68736B;">{{ favorite.favoritable.category?.name }}</p>
                            <p class="text-2xl font-bold mb-2 price-red" style="background-color: #315C47;  ">{{ formatPrice(favorite.favoritable.price) }} ₽</p>
                        </div>
                    </Link>
            ...
            <div v-if="favorites.length === 0" class="text-center py-16">
                ...
                <p class="text-xl font-medium" style="color: #68736B;">У вас пока нет избранных объявлений</p>
                <a href="/listings" class="inline-block mt-4 px-6 py-3 rounded-xl text-white font-medium transition-all hover:shadow-lg" style="background-color: #315C47;">
                    Смотреть объявления
                </a>
            </div>
        </div>
