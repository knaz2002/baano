        ...
        <div class="min-h-screen pb-20" style="background-color: #E8E6E1;">
            <div class="max-w-4xl mx-auto px-4 py-8">
                ...
                <div v-if="!reviews || reviews.length === 0" class="bg-white rounded-2xl shadow-lg p-8 text-center">
                    ...
                    <p class="text-lg font-medium text-gray-700">У вас пока нет отзывов</p>
                    <p class="text-gray-500 mt-2">Отзывы появятся, когда другие пользователи оценят вашу работу</p>
                </div>
