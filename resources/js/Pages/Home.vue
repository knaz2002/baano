<template>
    <AppLayout :categories="allParentCategories" @toggle-catalog="handleToggleCatalog">
        <div class="flex gap-6 mb-12 items-start">
            <!-- Левый сайдбар: Каталог или Фильтры -->
           <div v-if="showCatalog || showFilters" class="w-64 flex-shrink-0 pt-20">
                <div class="sticky top-24">
                    <!-- Каталог -->
                    <div v-if="showCatalog" class="glass p-6" style="border-radius: 16px;">
                        <h2 class="text-2xl font-bold mb-4" style="color: #3D4449;">Каталог</h2>
                                ...
                                >
                                    <div v-for="child in category.children" :key="child.id" class="relative">
                                        ...
                                        <div 
                                            ...
                                            class="absolute left-full top-0 ml-2 modal-glass z-30 p-4min-w-64"
            ...
            <!-- Основной контент: 4 колонки, 2 ряда = 8 карточек -->
            <div :class="showCatalog || showFilters ? 'flex-1' : 'w-full'">
                    ...
                    >
                        ...
                        <div class="p-4">
                            ...
                            <template v-if="item.listing">
                                <p class="text-sm mb-2" style="color: #5A6268;">
                                    {{ item.listing.title }}
                                </p>
                                ...
                                <p class="text-sm" style="color: #5A6268;">
                                    {{ item.listing.description?.substring(0, 60) }}...
                                </p>
                            </template>
                            
                            <template v-else>
                                <p class="text-sm mt-4" style="color: #8B9A9E;">
                                    Объявлений пока нет
                                </p>
                            </template>
                        </div>
