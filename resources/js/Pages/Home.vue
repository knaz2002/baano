        ...
        <div class="max-w-7xl mx-auto px-4 py-8">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center gap-3 mb-3">
                            ...
                            <div class="min-w-0 flex-1">
                                <h3 class="font-bold text-lg leading-tight mb-1" style="color: #1D1B20;">{{ cat.name }}</h3>
            ...
            <div class="mb-12">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-2xl font-bold" style="color: #1D1B20;">Рекомендуем для вас</h2>
            ...
            <div class="mb-12">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h2 class="text-2xl font-bold" style="color: #1D1B20;">VIP объявления</h2>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    >
                        ...
                        <div class="p-5">
                            <h3 class="font-bold text-lg text-gray-900 mb-2 line-clamp-2">{{ listing.title }}</h3>
                            <p class="text-2xl font-bold mb-2" style="background: linear-gradient(135deg, #F08080 0%, #9B7FCF 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">{{ formatPrice(listing.price) }} ₽</p>
