            ...
            <div class="flex flex-col md:flex-row min-h-screen">
                ...
                <aside class="hidden md:flex md:flex-col w-64 bg-white border-r flex-shrink-0" style="border-color: #E8E3DA;">
                    ...
                    <nav class="flex-1 p-4 space-y-2 overflow-y-auto dashboard-menu">
                        <!-- Главная -->
                        <Link href="/" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all hover:bg-[#F1F6F2] dashboard-menu-link" style="--menu-accent: #fe0000;">
                        ...
                        <!-- Личная информация -->
                        <Link href="/profile/edit" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all hover:bg-[#F1F6F2] dashboard-menu-link" :class="isActive('/profile') ? 'bg-[#F1F6F2]' : ''" style="--menu-accent: #315C47;">
                            <svg class="w-5 h-5" style="color: #315C47;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Сообщения -->
                        <Link href="/dashboard/messages" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all hover:bg-[#F1F6F2] dashboard-menu-link" :class="isActive('/dashboard/messages') ? 'bg-[#F1F6F2]' : ''" style="--menu-accent: #fe0000;">
                            <svg class="w-5 h-5" style="color: #315C47;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Мои объявления -->
                        <Link href="/user/listings" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all hover:bg-[#F1F6F2] dashboard-menu-link" :class="isActive('/user/listings') ? 'bg-[#F1F6F2]' : ''" style="--menu-accent: #315C47;">
                            <svg class="w-5 h-5" style="color: #315C47;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Избранное -->
                        <Link href="/user/favorites" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all hover:bg-[#F1F6F2] dashboard-menu-link" :class="isActive('/user/favorites') ? 'bg-[#F1F6F2]' : ''" style="--menu-accent: #fe0000;">
                            <svg class="w-5 h-5" style="color: #315C47;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Отзывы -->
                        <Link href="/dashboard/reviews" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all hover:bg-[#F1F6F2] dashboard-menu-link" :class="isActive('/dashboard/reviews') ? 'bg-[#F1F6F2]' : ''" style="--menu-accent: #315C47;">
                            <svg class="w-5 h-5" style="color: #315C47;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
