<template>
    <div class="min-h-screen" style="background-color: #E8E6E1;">
        <!-- Оверлей для мобильных (вынесен отдельно) -->
        <div 
            v-if="showSidebar" 
        ...
        <div class="max-w-7xl mx-auto px-3 md:px-4 py-4 md:py-8">
            ...
            <button 
                ...
                class="md:hidden mb-4 px-4 py-2 rounded-xl bg-white shadow flex items-center gap-2 w-full justify-center"
            >
...
// Автоматически закрывать меню при смене страницы
watch(() => usePage().url, () => {
